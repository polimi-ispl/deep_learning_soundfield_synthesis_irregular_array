...
def main():
    ...
    if args.gt_soundfield:
        np.save(os.path.join(dataset_path, 'gt_soundfield_train'+'_cp' + str(len(params_linear.idx_cp)) + '.npy'), P_gt)

        print('SAVED '+os.path.join(dataset_path, 'gt_soundfield_train'+'_cp' + str(len(params_linear.idx_cp)) + '.npy'))
    else:
        np.save(os.path.join(dataset_path,'filters_config_nl_' + str(params_linear.N_lspks) + '_missing_' + str(N_missing) +'_cp' + str(len(params_linear.idx_cp)) + '.npy'), d_array)

    print('SAVED'+ os.path.join(dataset_path,'filters_config_nl_' + str(params_linear.N_lspks) + '_missing_' + str(N_missing) +'_cp' + str(len(params_linear.idx_cp)) + '.npy'))
